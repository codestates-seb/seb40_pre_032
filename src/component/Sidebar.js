...
function Sidebar() {
	return (
		<div className="p-2">
			<Link
				className="text-lg font-normal text-gray-500 hover:text-black focus:font-bold focus:text-black"
				to="/questions"
			>
			...
			<ul>
				...
				<Link
					className="text-sm font-normal text-gray-500 hover:text-black focus:font-bold focus:text-black"
					to="/questions"
				>
					<li className="mb-1.5">
			...
			<ul>
				...
				>
					<li className="flex flex-row">
						...
						<span className="mb-4">Explore Collectives</span>
					</li>
				</Link>
			</ul>
			<div className="flex flex-row">
