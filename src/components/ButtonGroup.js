...
function ButtonGroup() {
	return (
		<div className="w-[465px] flex">
			<div className="flex rounded  h-[34px] items-center mr-4">
				<a
					href="https://stackoverflow.com/questions"
					aria-current="page"
					className="rounded-l py-[5px] px-4 text-[13px]  h-full text-[#64686e] bg-white border border-[hsl(210,8%,65%)] hover:bg-gray-100  hover:text-gray-900 focus:z-10   focus:text-[#64686e]  "
				>
					<div>Newest</div>
				</a>
				<a
				...
				<a
					href="https://stackoverflow.com/questions"
					className="rounded-r py-[5px] px-4 text-[13px] h-full text-[#64686e] bg-white border border-[hsl(210,8%,65%)] hover:bg-gray-100 hover:text-gray-900 focus:z-10   focus:text-[#64686e]  "
				>
					<div>Unanswered</div>
				</a>
			</div>
