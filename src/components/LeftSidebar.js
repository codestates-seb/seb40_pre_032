	...
	return (
		<div className="p-2 w-48 pt-[28px] ">
			<div className="fixed">
				...
				<div className="p-1 text-[11px] font-normal text-gray-500 mb-1.5">
					PUBLIC
				</div>
				<ul className="mb-3">
					<Link
					...
					>
						<li>
							<div className="p-1 h-8 flex flex-row items-center group-focus:bg-gray-100 group-focus:border-r-4 group-focus:border-orange-400">
								<span className="ml-6 text-[13px]">Tags</span>
							</div>
						</li>
					</div>
					<div
					...
					>
						<li className="">
							<div className="p-1 h-8 flex flex-row items-center group-focus:bg-gray-100 group-focus:border-r-4 group-focus:border-orange-400">
								<span className="ml-6 text-[13px]">Users</span>
							</div>
						</li>
					</div>
				</ul>
				<div className="flex flex-row">
					<span className="p-1 text-[11px] font-normal text-gray-500">
						COLLECTIVES
					</span>
					<svg
						aria-hidden="true"
				...
				<div className="flex flex-row">
					<span className="p-1 flex text-[11px] items-center font-normal text-gray-500">
						TEAMS
					</span>
					<svg
						aria-hidden="true"
