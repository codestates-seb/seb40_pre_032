...
//        todo: 배포시에는 아마존으로 수정
//        getRedirectStrategy().sendRedirect(request, response, "http://ec2-43-201-80-20.ap-northeast-2.compute.amazonaws.com:8080/callback/access_token=bearer " + accessToken);   // (6-4)
        getRedirectStrategy().sendRedirect(request, response, "http://pre-032-bucket.s3-website.ap-northeast-2.amazonaws.com:8080/callback/access_token=bearer " + accessToken);   // (6-4)
